    ...
    <section className="relative w-full bg-zinc-50 dark:bg-zinc-900/50 py-32 px-4 sm:px-6 lg:px-8 border-y border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto max-w-7xl flex flex-col items-center">
        ...
        <div className="relative w-full max-w-5xl">
          <div className="w-full aspect-[16/10] bg-zinc-200 dark:bg-zinc-800 rounded-xl shadow-2xl border border-zinc-300 dark:border-zinc-700 overflow-hidden relative z-10 flex items-center justify-center">
            <div className="absolute top-0 w-full h-10 bg-zinc-300 dark:bg-zinc-900 flex items-center px-4 gap-2 border-b border-zinc-400 dark:border-zinc-700">
          ...
          {/* Top Left */}
          <div className="hidden md:flex absolute -left-12 lg:-left-24 top-[10%] z-20 w-72 bg-white dark:bg-zinc-900 p-5 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 flex-col gap-3 transition-transform hover:-translate-y-1">
          ...
          {/* Top Right */}
          <div className="hidden md:flex absolute -right-12 lg:-right-24 top-[20%] z-20 w-72 bg-white dark:bg-zinc-900 p-5 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 flex-col gap-3 transition-transform hover:-translate-y-1">
          ...
          {/* Bottom Left */}
          <div className="hidden md:flex absolute -left-8 lg:-left-16 bottom-[20%] z-20 w-72 bg-white dark:bg-zinc-900 p-5 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 flex-col gap-3 transition-transform hover:-translate-y-1">
          ...
          {/* Bottom Right */}
          <div className="hidden md:flex absolute -right-8 lg:-right-16 bottom-[5%] z-20 w-72 bg-white dark:bg-zinc-900 p-5 rounded-xl shadow-xl border border-zinc-100 dark:border-zinc-800 flex-col gap-3 transition-transform hover:-translate-y-1">
          ...
          <div className="md:hidden mt-12 grid grid-cols-1 gap-6">
