...
import { Trash2, Save, History, Bookmark, Play, Eraser } from "lucide-react";
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          {Object.keys(savedQueries).length > 0 && (
            ...
            >
              <Eraser className="w-3.5 h-3.5 mr-1" /> Clear All
            </Button>
          )}
        </div>
          ...
          {Object.entries(savedQueries).length === 0 ? (
            ...
            Object.entries(savedQueries).map(([name, savedTree]) => (
              ...
              >
                <button
                  onClick={() => {
                    importQuery(savedTree);
                    toast.success("Saved query loaded successfully");
                  }}
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        importQuery(entry.tree);
                        toast.success("Restored query from history");
                      }}
